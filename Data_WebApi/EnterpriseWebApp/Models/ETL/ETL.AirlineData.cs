...
{
    public class AirlineData : IDataEntityObjects
    {
        ...
        public AirlineData(int iD, int user_ID, string gender, string customerType, int age, string travelType, string @class, int distance, int inflightWifi,
            ...
            int legRoom, int baggage, int checkin, int inflightService, int cleanliness, int departDelay, int arriveDelay, string satisfaction, DateTime dataDate,
            bool isTrain)
        {
            ID = iD;
            User_ID = user_ID;
