...
namespace EnterpriseWebApp.Models.ETL
{
    public class CleanModelInput : IDataEntityObjects
    {
        ...
        public CleanModelInput(int iD, int airlineDataID, int user_ID, int gender_Female, int gender_Male, int customerType_Loyal, int customerType_Disloyal, int age,
            ...
            int departDelay, int arriveDelay, string satisfaction, DateTime dataDate, bool isTrain, int travelType_personal, int class_eco, DateTime runDate)
        {
            ID = iD;
